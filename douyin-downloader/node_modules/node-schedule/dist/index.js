    ...
    for (var i = 0, l = ranges.length; i < l; ++i) {
      ...
      if (range.step * multiplier > range.end) {
        result = result.concat(
          Array.from({ length: range.end - range.start + 1 }).map(function(_, index2) {
...
function requireSchedule() {
  ...
  function rescheduleJob2(job, spec) {
  ...
  schedule$1 = {
    ...
    scheduledJobs: scheduledJobs2,
    cancelJob: cancelJob2,
    gracefulShutdown: gracefulShutdown2
  };
  return schedule$1;
}
var nodeSchedule;
...
function requireNodeSchedule() {
  ...
  const { cancelJob: cancelJob2, rescheduleJob: rescheduleJob2, scheduledJobs: scheduledJobs2, scheduleJob: scheduleJob2, gracefulShutdown: gracefulShutdown2 } = requireSchedule();
...
const index = /* @__PURE__ */ getDefaultExportFromCjs(nodeScheduleExports);
const schedule = /* @__PURE__ */ _mergeNamespaces({
  __proto__: null,
  default: index
}, [nodeScheduleExports]);
