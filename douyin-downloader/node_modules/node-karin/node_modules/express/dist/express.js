...
function requireFinalhandler() {
  ...
  var debug = requireBrowser()("finalhandler");
...
function requireDist() {
  ...
  function compile(path, options = {}) {
    ...
    const data = path instanceof TokenData ? path : parse2(path, options);
...
function requireLayer() {
  ...
  const debug = requireBrowser()("router:layer");
...
function requireRouter() {
  ...
  Router2.prototype.route = function route2(path) {
    const route3 = new Route2(path);
    const layer2 = new Layer(path, {
      sensitive: this.caseSensitive,
      strict: this.strict,
      end: true
  ...
  methods.concat("all").forEach(function(method) {
    Router2.prototype[method] = function(path) {
...
function requireApplication() {
  ...
  (function(module, exports) {
    ...
    app.route = function route2(path) {
