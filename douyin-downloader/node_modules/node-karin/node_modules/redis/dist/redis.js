...
function requireGenericTransformers() {
  ...
  var GeoReplyWith2;
  (function(GeoReplyWith3) {
    GeoReplyWith3["DISTANCE"] = "WITHDIST";
    GeoReplyWith3["HASH"] = "WITHHASH";
    GeoReplyWith3["COORDINATES"] = "WITHCOORD";
  })(GeoReplyWith2 || (genericTransformers.GeoReplyWith = GeoReplyWith2 = {}));
  function transformGeoMembersWithReply(reply, replyWith) {
    const replyWithSet = new Set(replyWith);
    let index2 = 0;
    const distanceIndex = replyWithSet.has(GeoReplyWith2.DISTANCE) && ++index2, hashIndex = replyWithSet.has(GeoReplyWith2.HASH) && ++index2, coordinatesIndex = replyWithSet.has(GeoReplyWith2.COORDINATES) && ++index2;
...
function requireHEXPIRE() {
  ...
  HEXPIRE.transformArguments = HEXPIRE.FIRST_KEY_INDEX = HEXPIRE.HASH_EXPIRATION = void 0;
  const generic_transformers_1 = requireGenericTransformers();
  ...
  HEXPIRE.transformArguments = transformArguments;
  return HEXPIRE;
}
var HEXPIREAT = {};
...
function requireHEXPIREAT() {
  ...
  HEXPIREAT.transformArguments = HEXPIREAT.FIRST_KEY_INDEX = void 0;
  const generic_transformers_1 = requireGenericTransformers();
  HEXPIREAT.FIRST_KEY_INDEX = 1;
  ...
  HEXPIREAT.transformArguments = transformArguments;
  return HEXPIREAT;
}
var HEXPIRETIME = {};
...
function requireHEXPIRETIME() {
  ...
  HEXPIRETIME.transformArguments = HEXPIRETIME.IS_READ_ONLY = HEXPIRETIME.FIRST_KEY_INDEX = HEXPIRETIME.HASH_EXPIRATION_TIME = void 0;
  const generic_transformers_1 = requireGenericTransformers();
...
function requireHPERSIST() {
  ...
  HPERSIST.transformArguments = HPERSIST.FIRST_KEY_INDEX = void 0;
  const generic_transformers_1 = requireGenericTransformers();
  HPERSIST.FIRST_KEY_INDEX = 1;
  function transformArguments(key, fields) {
    return (0, generic_transformers_1.pushVerdictArgument)(["HPERSIST", key, "FIELDS"], fields);
  }
  HPERSIST.transformArguments = transformArguments;
  return HPERSIST;
}
var HPEXPIRE = {};
...
function requireHPEXPIRE() {
  ...
  HPEXPIRE.transformArguments = HPEXPIRE.FIRST_KEY_INDEX = void 0;
  const generic_transformers_1 = requireGenericTransformers();
  HPEXPIRE.FIRST_KEY_INDEX = 1;
  ...
  HPEXPIRE.transformArguments = transformArguments;
  return HPEXPIRE;
}
var HPEXPIREAT = {};
...
function requireHPEXPIREAT() {
  ...
  HPEXPIREAT.transformArguments = HPEXPIREAT.IS_READ_ONLY = HPEXPIREAT.FIRST_KEY_INDEX = void 0;
  const generic_transformers_1 = requireGenericTransformers();
  HPEXPIREAT.FIRST_KEY_INDEX = 1;
  HPEXPIREAT.IS_READ_ONLY = true;
  function transformArguments(key, fields, timestamp, mode) {
  ...
  HPEXPIREAT.transformArguments = transformArguments;
  return HPEXPIREAT;
}
var HPEXPIRETIME = {};
...
function requireHPEXPIRETIME() {
  ...
  HPEXPIRETIME.transformArguments = HPEXPIRETIME.IS_READ_ONLY = HPEXPIRETIME.FIRST_KEY_INDEX = void 0;
  const generic_transformers_1 = requireGenericTransformers();
  HPEXPIRETIME.FIRST_KEY_INDEX = 1;
  HPEXPIRETIME.IS_READ_ONLY = true;
  function transformArguments(key, fields) {
    return (0, generic_transformers_1.pushVerdictArgument)(["HPEXPIRETIME", key, "FIELDS"], fields);
  }
  HPEXPIRETIME.transformArguments = transformArguments;
  return HPEXPIRETIME;
}
var HPTTL = {};
...
function requireHPTTL() {
  ...
  HPTTL.transformArguments = HPTTL.IS_READ_ONLY = HPTTL.FIRST_KEY_INDEX = void 0;
  const generic_transformers_1 = requireGenericTransformers();
  HPTTL.FIRST_KEY_INDEX = 1;
  HPTTL.IS_READ_ONLY = true;
  function transformArguments(key, fields) {
    return (0, generic_transformers_1.pushVerdictArgument)(["HPTTL", key, "FIELDS"], fields);
  }
  HPTTL.transformArguments = transformArguments;
  return HPTTL;
}
...
function requireHSCAN_NOVALUES() {
  ...
  (function(exports) {
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.transformReply = exports.transformArguments = exports.IS_READ_ONLY = exports.FIRST_KEY_INDEX = void 0;
    const HSCAN_1 = requireHSCAN();
    var HSCAN_2 = requireHSCAN();
    Object.defineProperty(exports, "FIRST_KEY_INDEX", { enumerable: true, get: function() {
...
function requireHTTL() {
  ...
  HTTL.transformArguments = HTTL.IS_READ_ONLY = HTTL.FIRST_KEY_INDEX = void 0;
  const generic_transformers_1 = requireGenericTransformers();
  HTTL.FIRST_KEY_INDEX = 1;
  HTTL.IS_READ_ONLY = true;
  function transformArguments(key, fields) {
    return (0, generic_transformers_1.pushVerdictArgument)(["HTTL", key, "FIELDS"], fields);
  }
  HTTL.transformArguments = transformArguments;
  return HTTL;
}
var HVALS = {};
...
function requireLINDEX() {
  ...
  function transformArguments(key, index2) {
    return ["LINDEX", key, index2.toString()];
  }
...
function requireLSET() {
  ...
  function transformArguments(key, index2, element) {
    return [
      "LSET",
      key,
      index2.toString(),
...
function requireCommands$6() {
  ...
  const APPEND2 = requireAPPEND();
  const BITCOUNT2 = requireBITCOUNT();
  const BITFIELD_RO2 = requireBITFIELD_RO();
  const BITFIELD2 = requireBITFIELD();
  const BITOP2 = requireBITOP();
  const BITPOS2 = requireBITPOS();
  const BLMOVE2 = requireBLMOVE();
  const BLMPOP2 = requireBLMPOP();
  const BLPOP2 = requireBLPOP();
  const BRPOP2 = requireBRPOP();
  const BRPOPLPUSH2 = requireBRPOPLPUSH();
  const BZMPOP2 = requireBZMPOP();
  const BZPOPMAX2 = requireBZPOPMAX();
  const BZPOPMIN2 = requireBZPOPMIN();
  const COPY2 = requireCOPY();
  const DECR2 = requireDECR();
  const DECRBY2 = requireDECRBY$1();
  const DEL2 = requireDEL$3();
  const DUMP2 = requireDUMP();
  const EVAL_RO2 = requireEVAL_RO();
  const EVAL2 = requireEVAL();
  const EVALSHA_RO2 = requireEVALSHA_RO();
  const EVALSHA2 = requireEVALSHA();
  const EXISTS2 = requireEXISTS$2();
  const EXPIRE2 = requireEXPIRE();
  const EXPIREAT2 = requireEXPIREAT();
  const EXPIRETIME2 = requireEXPIRETIME();
  const FCALL_RO2 = requireFCALL_RO();
  const FCALL2 = requireFCALL();
  const GEOADD2 = requireGEOADD();
  const GEODIST2 = requireGEODIST();
  const GEOHASH2 = requireGEOHASH();
  const GEOPOS2 = requireGEOPOS();
  const GEORADIUS_RO_WITH2 = requireGEORADIUS_RO_WITH();
  const GEORADIUS_RO2 = requireGEORADIUS_RO();
  const GEORADIUS_WITH2 = requireGEORADIUS_WITH();
  const GEORADIUS2 = requireGEORADIUS();
  const GEORADIUSBYMEMBER_RO_WITH2 = requireGEORADIUSBYMEMBER_RO_WITH();
  const GEORADIUSBYMEMBER_RO2 = requireGEORADIUSBYMEMBER_RO();
  const GEORADIUSBYMEMBER_WITH2 = requireGEORADIUSBYMEMBER_WITH();
  const GEORADIUSBYMEMBER2 = requireGEORADIUSBYMEMBER();
  const GEORADIUSBYMEMBERSTORE2 = requireGEORADIUSBYMEMBERSTORE();
  const GEORADIUSSTORE2 = requireGEORADIUSSTORE();
  const GEOSEARCH_WITH2 = requireGEOSEARCH_WITH();
  const GEOSEARCH2 = requireGEOSEARCH();
  const GEOSEARCHSTORE2 = requireGEOSEARCHSTORE();
  const GET2 = requireGET$2();
  const GETBIT2 = requireGETBIT();
  const GETDEL2 = requireGETDEL();
  const GETEX2 = requireGETEX();
  const GETRANGE2 = requireGETRANGE();
  const GETSET2 = requireGETSET();
  const HDEL2 = requireHDEL();
  const HEXISTS2 = requireHEXISTS();
  const HEXPIRE2 = requireHEXPIRE();
  const HEXPIREAT2 = requireHEXPIREAT();
  const HEXPIRETIME2 = requireHEXPIRETIME();
  const HGET2 = requireHGET();
  const HGETALL2 = requireHGETALL();
  const HINCRBY2 = requireHINCRBY();
  const HINCRBYFLOAT2 = requireHINCRBYFLOAT();
  const HKEYS2 = requireHKEYS();
  const HLEN2 = requireHLEN();
  const HMGET2 = requireHMGET();
  const HPERSIST2 = requireHPERSIST();
  const HPEXPIRE2 = requireHPEXPIRE();
  const HPEXPIREAT2 = requireHPEXPIREAT();
  const HPEXPIRETIME2 = requireHPEXPIRETIME();
  const HPTTL2 = requireHPTTL();
  const HRANDFIELD_COUNT_WITHVALUES2 = requireHRANDFIELD_COUNT_WITHVALUES();
  const HRANDFIELD_COUNT2 = requireHRANDFIELD_COUNT();
  const HRANDFIELD2 = requireHRANDFIELD();
  const HSCAN2 = requireHSCAN();
  const HSCAN_NOVALUES2 = requireHSCAN_NOVALUES();
  const HSET2 = requireHSET();
  const HSETNX2 = requireHSETNX();
  const HSTRLEN2 = requireHSTRLEN();
  const HTTL2 = requireHTTL();
  const HVALS2 = requireHVALS();
  const INCR2 = requireINCR();
  const INCRBY2 = requireINCRBY$3();
  const INCRBYFLOAT2 = requireINCRBYFLOAT();
  const LCS_IDX_WITHMATCHLEN2 = requireLCS_IDX_WITHMATCHLEN();
  const LCS_IDX2 = requireLCS_IDX();
  const LCS_LEN2 = requireLCS_LEN();
  const LCS2 = requireLCS();
  const LINDEX2 = requireLINDEX();
  const LINSERT2 = requireLINSERT();
  const LLEN2 = requireLLEN();
  const LMOVE2 = requireLMOVE();
  const LMPOP2 = requireLMPOP();
  const LPOP_COUNT2 = requireLPOP_COUNT();
  const LPOP2 = requireLPOP();
  const LPOS_COUNT2 = requireLPOS_COUNT();
  const LPOS2 = requireLPOS();
  const LPUSH2 = requireLPUSH();
  const LPUSHX2 = requireLPUSHX();
  const LRANGE2 = requireLRANGE();
  const LREM2 = requireLREM();
  const LSET2 = requireLSET();
  const LTRIM2 = requireLTRIM();
  const MGET2 = requireMGET$2();
  const MIGRATE2 = requireMIGRATE();
  const MSET2 = requireMSET$1();
  const MSETNX2 = requireMSETNX();
  const OBJECT_ENCODING2 = requireOBJECT_ENCODING();
  const OBJECT_FREQ2 = requireOBJECT_FREQ();
  const OBJECT_IDLETIME2 = requireOBJECT_IDLETIME();
  const OBJECT_REFCOUNT2 = requireOBJECT_REFCOUNT();
  const PERSIST2 = requirePERSIST();
  const PEXPIRE2 = requirePEXPIRE();
  const PEXPIREAT2 = requirePEXPIREAT();
  const PEXPIRETIME2 = requirePEXPIRETIME();
  const PFADD2 = requirePFADD();
  const PFCOUNT2 = requirePFCOUNT();
  const PFMERGE2 = requirePFMERGE();
  const PSETEX2 = requirePSETEX();
  const PTTL2 = requirePTTL();
  const PUBLISH2 = requirePUBLISH();
  const RENAME2 = requireRENAME();
  const RENAMENX2 = requireRENAMENX();
  const RESTORE2 = requireRESTORE();
  const RPOP_COUNT2 = requireRPOP_COUNT();
  const RPOP2 = requireRPOP();
  const RPOPLPUSH2 = requireRPOPLPUSH();
  const RPUSH2 = requireRPUSH();
  const RPUSHX2 = requireRPUSHX();
  const SADD2 = requireSADD();
  const SCARD2 = requireSCARD();
  const SDIFF2 = requireSDIFF();
  const SDIFFSTORE2 = requireSDIFFSTORE();
  const SET2 = requireSET$1();
  const SETBIT2 = requireSETBIT();
  const SETEX2 = requireSETEX();
  const SETNX2 = requireSETNX();
  const SETRANGE2 = requireSETRANGE();
  const SINTER2 = requireSINTER();
  const SINTERCARD2 = requireSINTERCARD();
  const SINTERSTORE2 = requireSINTERSTORE();
  const SISMEMBER2 = requireSISMEMBER();
  const SMEMBERS2 = requireSMEMBERS();
  const SMISMEMBER2 = requireSMISMEMBER();
  const SMOVE2 = requireSMOVE();
  const SORT_RO2 = requireSORT_RO();
  const SORT_STORE2 = requireSORT_STORE();
  const SORT2 = requireSORT();
  const SPOP2 = requireSPOP();
  const SPUBLISH2 = requireSPUBLISH();
  const SRANDMEMBER_COUNT2 = requireSRANDMEMBER_COUNT();
  const SRANDMEMBER2 = requireSRANDMEMBER();
  const SREM2 = requireSREM();
  const SSCAN2 = requireSSCAN();
  const STRLEN2 = requireSTRLEN$1();
  const SUNION2 = requireSUNION();
  const SUNIONSTORE2 = requireSUNIONSTORE();
  const TOUCH2 = requireTOUCH();
  const TTL2 = requireTTL();
  const TYPE2 = requireTYPE$1();
  const UNLINK2 = requireUNLINK();
  const WATCH2 = requireWATCH();
  const XACK2 = requireXACK();
  const XADD2 = requireXADD();
  const XAUTOCLAIM_JUSTID2 = requireXAUTOCLAIM_JUSTID();
  const XAUTOCLAIM2 = requireXAUTOCLAIM();
  const XCLAIM_JUSTID2 = requireXCLAIM_JUSTID();
  const XCLAIM2 = requireXCLAIM();
  const XDEL2 = requireXDEL();
  const XGROUP_CREATE2 = requireXGROUP_CREATE();
  const XGROUP_CREATECONSUMER2 = requireXGROUP_CREATECONSUMER();
  const XGROUP_DELCONSUMER2 = requireXGROUP_DELCONSUMER();
  const XGROUP_DESTROY2 = requireXGROUP_DESTROY();
  const XGROUP_SETID2 = requireXGROUP_SETID();
  const XINFO_CONSUMERS2 = requireXINFO_CONSUMERS();
  const XINFO_GROUPS2 = requireXINFO_GROUPS();
  const XINFO_STREAM2 = requireXINFO_STREAM();
  const XLEN2 = requireXLEN();
  const XPENDING_RANGE2 = requireXPENDING_RANGE();
  const XPENDING2 = requireXPENDING();
  const XRANGE2 = requireXRANGE();
  const XREAD2 = requireXREAD();
  const XREADGROUP2 = requireXREADGROUP();
  const XREVRANGE2 = requireXREVRANGE();
  const XSETID2 = requireXSETID();
  const XTRIM2 = requireXTRIM();
  const ZADD2 = requireZADD();
  const ZCARD2 = requireZCARD();
  const ZCOUNT2 = requireZCOUNT();
  const ZDIFF_WITHSCORES2 = requireZDIFF_WITHSCORES();
  const ZDIFF2 = requireZDIFF();
  const ZDIFFSTORE2 = requireZDIFFSTORE();
  const ZINCRBY2 = requireZINCRBY();
  const ZINTER_WITHSCORES2 = requireZINTER_WITHSCORES();
  const ZINTER2 = requireZINTER();
  const ZINTERCARD2 = requireZINTERCARD();
  const ZINTERSTORE2 = requireZINTERSTORE();
  const ZLEXCOUNT2 = requireZLEXCOUNT();
  const ZMPOP2 = requireZMPOP();
  const ZMSCORE2 = requireZMSCORE();
  const ZPOPMAX_COUNT2 = requireZPOPMAX_COUNT();
  const ZPOPMAX2 = requireZPOPMAX();
  const ZPOPMIN_COUNT2 = requireZPOPMIN_COUNT();
  const ZPOPMIN2 = requireZPOPMIN();
  const ZRANDMEMBER_COUNT_WITHSCORES2 = requireZRANDMEMBER_COUNT_WITHSCORES();
  const ZRANDMEMBER_COUNT2 = requireZRANDMEMBER_COUNT();
  const ZRANDMEMBER2 = requireZRANDMEMBER();
  const ZRANGE_WITHSCORES2 = requireZRANGE_WITHSCORES();
  const ZRANGE2 = requireZRANGE();
  const ZRANGEBYLEX2 = requireZRANGEBYLEX();
  const ZRANGEBYSCORE_WITHSCORES2 = requireZRANGEBYSCORE_WITHSCORES();
  const ZRANGEBYSCORE2 = requireZRANGEBYSCORE();
  const ZRANGESTORE2 = requireZRANGESTORE();
  const ZRANK2 = requireZRANK();
  const ZREM2 = requireZREM();
  const ZREMRANGEBYLEX2 = requireZREMRANGEBYLEX();
  const ZREMRANGEBYRANK2 = requireZREMRANGEBYRANK();
  const ZREMRANGEBYSCORE2 = requireZREMRANGEBYSCORE();
  const ZREVRANK2 = requireZREVRANK();
  const ZSCAN2 = requireZSCAN();
  const ZSCORE2 = requireZSCORE();
  const ZUNION_WITHSCORES2 = requireZUNION_WITHSCORES();
  const ZUNION2 = requireZUNION();
  const ZUNIONSTORE2 = requireZUNIONSTORE();
  commands$5.default = {
    APPEND: APPEND2,
    append: APPEND2,
    BITCOUNT: BITCOUNT2,
    bitCount: BITCOUNT2,
    BITFIELD_RO: BITFIELD_RO2,
    bitFieldRo: BITFIELD_RO2,
    BITFIELD: BITFIELD2,
    bitField: BITFIELD2,
    BITOP: BITOP2,
    bitOp: BITOP2,
    ...
    EVALSHA: EVALSHA2,
    evalSha: EVALSHA2,
    EVALSHA_RO: EVALSHA_RO2,
    evalShaRo: EVALSHA_RO2,
    EXISTS: EXISTS2,
    exists: EXISTS2,
    EXPIRE: EXPIRE2,
    expire: EXPIRE2,
    ...
    GEOPOS: GEOPOS2,
    geoPos: GEOPOS2,
    GEORADIUS_RO_WITH: GEORADIUS_RO_WITH2,
    geoRadiusRoWith: GEORADIUS_RO_WITH2,
    GEORADIUS_RO: GEORADIUS_RO2,
    geoRadiusRo: GEORADIUS_RO2,
    GEORADIUS_WITH: GEORADIUS_WITH2,
    geoRadiusWith: GEORADIUS_WITH2,
    GEORADIUS: GEORADIUS2,
    geoRadius: GEORADIUS2,
    GEORADIUSBYMEMBER_RO_WITH: GEORADIUSBYMEMBER_RO_WITH2,
    geoRadiusByMemberRoWith: GEORADIUSBYMEMBER_RO_WITH2,
    GEORADIUSBYMEMBER_RO: GEORADIUSBYMEMBER_RO2,
    geoRadiusByMemberRo: GEORADIUSBYMEMBER_RO2,
    GEORADIUSBYMEMBER_WITH: GEORADIUSBYMEMBER_WITH2,
    geoRadiusByMemberWith: GEORADIUSBYMEMBER_WITH2,
    GEORADIUSBYMEMBER: GEORADIUSBYMEMBER2,
    geoRadiusByMember: GEORADIUSBYMEMBER2,
    GEORADIUSBYMEMBERSTORE: GEORADIUSBYMEMBERSTORE2,
    geoRadiusByMemberStore: GEORADIUSBYMEMBERSTORE2,
    GEORADIUSSTORE: GEORADIUSSTORE2,
    geoRadiusStore: GEORADIUSSTORE2,
    GEOSEARCH_WITH: GEOSEARCH_WITH2,
    geoSearchWith: GEOSEARCH_WITH2,
    GEOSEARCH: GEOSEARCH2,
    geoSearch: GEOSEARCH2,
    GEOSEARCHSTORE: GEOSEARCHSTORE2,
    geoSearchStore: GEOSEARCHSTORE2,
    GET: GET2,
    get: GET2,
    GETBIT: GETBIT2,
    ...
    HEXPIRE: HEXPIRE2,
    hExpire: HEXPIRE2,
    HEXPIREAT: HEXPIREAT2,
    hExpireAt: HEXPIREAT2,
    HEXPIRETIME: HEXPIRETIME2,
    hExpireTime: HEXPIRETIME2,
    HGET: HGET2,
    hGet: HGET2,
    HGETALL: HGETALL2,
    ...
    HPEXPIRE: HPEXPIRE2,
    hpExpire: HPEXPIRE2,
    HPEXPIREAT: HPEXPIREAT2,
    hpExpireAt: HPEXPIREAT2,
    HPEXPIRETIME: HPEXPIRETIME2,
    hpExpireTime: HPEXPIRETIME2,
    HPTTL: HPTTL2,
    hpTTL: HPTTL2,
    HRANDFIELD_COUNT_WITHVALUES: HRANDFIELD_COUNT_WITHVALUES2,
    hRandFieldCountWithValues: HRANDFIELD_COUNT_WITHVALUES2,
    HRANDFIELD_COUNT: HRANDFIELD_COUNT2,
    hRandFieldCount: HRANDFIELD_COUNT2,
    HRANDFIELD: HRANDFIELD2,
    hRandField: HRANDFIELD2,
    HSCAN: HSCAN2,
    hScan: HSCAN2,
    HSCAN_NOVALUES: HSCAN_NOVALUES2,
    hScanNoValues: HSCAN_NOVALUES2,
    HSET: HSET2,
    hSet: HSET2,
    HSETNX: HSETNX2,
    hSetNX: HSETNX2,
    ...
    INCRBY: INCRBY2,
    incrBy: INCRBY2,
    INCRBYFLOAT: INCRBYFLOAT2,
    incrByFloat: INCRBYFLOAT2,
    LCS_IDX_WITHMATCHLEN: LCS_IDX_WITHMATCHLEN2,
    lcsIdxWithMatchLen: LCS_IDX_WITHMATCHLEN2,
    LCS_IDX: LCS_IDX2,
    lcsIdx: LCS_IDX2,
    LCS_LEN: LCS_LEN2,
    lcsLen: LCS_LEN2,
    ...
    LMPOP: LMPOP2,
    lmPop: LMPOP2,
    LPOP_COUNT: LPOP_COUNT2,
    lPopCount: LPOP_COUNT2,
    LPOP: LPOP2,
    lPop: LPOP2,
    LPOS_COUNT: LPOS_COUNT2,
    lPosCount: LPOS_COUNT2,
    LPOS: LPOS2,
    lPos: LPOS2,
    LPUSH: LPUSH2,
    lPush: LPUSH2,
    ...
    MSETNX: MSETNX2,
    mSetNX: MSETNX2,
    OBJECT_ENCODING: OBJECT_ENCODING2,
    objectEncoding: OBJECT_ENCODING2,
    OBJECT_FREQ: OBJECT_FREQ2,
    objectFreq: OBJECT_FREQ2,
    OBJECT_IDLETIME: OBJECT_IDLETIME2,
    objectIdleTime: OBJECT_IDLETIME2,
    OBJECT_REFCOUNT: OBJECT_REFCOUNT2,
    objectRefCount: OBJECT_REFCOUNT2,
    PERSIST: PERSIST2,
    persist: PERSIST2,
    PEXPIRE: PEXPIRE2,
    pExpire: PEXPIRE2,
    PEXPIREAT: PEXPIREAT2,
    pExpireAt: PEXPIREAT2,
    PEXPIRETIME: PEXPIRETIME2,
    pExpireTime: PEXPIRETIME2,
    PFADD: PFADD2,
    pfAdd: PFADD2,
    PFCOUNT: PFCOUNT2,
    ...
    RESTORE: RESTORE2,
    restore: RESTORE2,
    RPOP_COUNT: RPOP_COUNT2,
    rPopCount: RPOP_COUNT2,
    RPOP: RPOP2,
    rPop: RPOP2,
    RPOPLPUSH: RPOPLPUSH2,
    rPopLPush: RPOPLPUSH2,
    RPUSH: RPUSH2,
    rPush: RPUSH2,
    RPUSHX: RPUSHX2,
    ...
    SDIFF: SDIFF2,
    sDiff: SDIFF2,
    SDIFFSTORE: SDIFFSTORE2,
    sDiffStore: SDIFFSTORE2,
    SINTER: SINTER2,
    sInter: SINTER2,
    SINTERCARD: SINTERCARD2,
    sInterCard: SINTERCARD2,
    SINTERSTORE: SINTERSTORE2,
    sInterStore: SINTERSTORE2,
    SET: SET2,
    set: SET2,
    SETBIT: SETBIT2,
    ...
    SETRANGE: SETRANGE2,
    setRange: SETRANGE2,
    SISMEMBER: SISMEMBER2,
    sIsMember: SISMEMBER2,
    SMEMBERS: SMEMBERS2,
    sMembers: SMEMBERS2,
    SMISMEMBER: SMISMEMBER2,
    smIsMember: SMISMEMBER2,
    SMOVE: SMOVE2,
    sMove: SMOVE2,
    SORT_RO: SORT_RO2,
    sortRo: SORT_RO2,
    SORT_STORE: SORT_STORE2,
    sortStore: SORT_STORE2,
    SORT: SORT2,
    sort: SORT2,
    SPOP: SPOP2,
    sPop: SPOP2,
    SPUBLISH: SPUBLISH2,
    sPublish: SPUBLISH2,
    SRANDMEMBER_COUNT: SRANDMEMBER_COUNT2,
    sRandMemberCount: SRANDMEMBER_COUNT2,
    SRANDMEMBER: SRANDMEMBER2,
    sRandMember: SRANDMEMBER2,
    SREM: SREM2,
    sRem: SREM2,
    SSCAN: SSCAN2,
    ...
    XADD: XADD2,
    xAdd: XADD2,
    XAUTOCLAIM_JUSTID: XAUTOCLAIM_JUSTID2,
    xAutoClaimJustId: XAUTOCLAIM_JUSTID2,
    XAUTOCLAIM: XAUTOCLAIM2,
    xAutoClaim: XAUTOCLAIM2,
    XCLAIM: XCLAIM2,
    xClaim: XCLAIM2,
    XCLAIM_JUSTID: XCLAIM_JUSTID2,
    xClaimJustId: XCLAIM_JUSTID2,
    XDEL: XDEL2,
    xDel: XDEL2,
    XGROUP_CREATE: XGROUP_CREATE2,
    xGroupCreate: XGROUP_CREATE2,
    XGROUP_CREATECONSUMER: XGROUP_CREATECONSUMER2,
    xGroupCreateConsumer: XGROUP_CREATECONSUMER2,
    XGROUP_DELCONSUMER: XGROUP_DELCONSUMER2,
    xGroupDelConsumer: XGROUP_DELCONSUMER2,
    XGROUP_DESTROY: XGROUP_DESTROY2,
    xGroupDestroy: XGROUP_DESTROY2,
    XGROUP_SETID: XGROUP_SETID2,
    xGroupSetId: XGROUP_SETID2,
    XINFO_CONSUMERS: XINFO_CONSUMERS2,
    xInfoConsumers: XINFO_CONSUMERS2,
    XINFO_GROUPS: XINFO_GROUPS2,
    xInfoGroups: XINFO_GROUPS2,
    XINFO_STREAM: XINFO_STREAM2,
    xInfoStream: XINFO_STREAM2,
    XLEN: XLEN2,
    xLen: XLEN2,
    XPENDING_RANGE: XPENDING_RANGE2,
    xPendingRange: XPENDING_RANGE2,
    XPENDING: XPENDING2,
    xPending: XPENDING2,
    XRANGE: XRANGE2,
    xRange: XRANGE2,
    XREAD: XREAD2,
    xRead: XREAD2,
    XREADGROUP: XREADGROUP2,
    xReadGroup: XREADGROUP2,
    XREVRANGE: XREVRANGE2,
    xRevRange: XREVRANGE2,
    XSETID: XSETID2,
    xSetId: XSETID2,
    XTRIM: XTRIM2,
    ...
    ZCOUNT: ZCOUNT2,
    zCount: ZCOUNT2,
    ZDIFF_WITHSCORES: ZDIFF_WITHSCORES2,
    zDiffWithScores: ZDIFF_WITHSCORES2,
    ZDIFF: ZDIFF2,
    zDiff: ZDIFF2,
    ZDIFFSTORE: ZDIFFSTORE2,
    zDiffStore: ZDIFFSTORE2,
    ZINCRBY: ZINCRBY2,
    zIncrBy: ZINCRBY2,
    ZINTER_WITHSCORES: ZINTER_WITHSCORES2,
    zInterWithScores: ZINTER_WITHSCORES2,
    ZINTER: ZINTER2,
    zInter: ZINTER2,
    ZINTERCARD: ZINTERCARD2,
    zInterCard: ZINTERCARD2,
    ZINTERSTORE: ZINTERSTORE2,
    zInterStore: ZINTERSTORE2,
    ZLEXCOUNT: ZLEXCOUNT2,
    zLexCount: ZLEXCOUNT2,
    ZMPOP: ZMPOP2,
    zmPop: ZMPOP2,
    ZMSCORE: ZMSCORE2,
    zmScore: ZMSCORE2,
    ZPOPMAX_COUNT: ZPOPMAX_COUNT2,
    zPopMaxCount: ZPOPMAX_COUNT2,
    ZPOPMAX: ZPOPMAX2,
    zPopMax: ZPOPMAX2,
    ZPOPMIN_COUNT: ZPOPMIN_COUNT2,
    zPopMinCount: ZPOPMIN_COUNT2,
    ZPOPMIN: ZPOPMIN2,
    zPopMin: ZPOPMIN2,
    ZRANDMEMBER_COUNT_WITHSCORES: ZRANDMEMBER_COUNT_WITHSCORES2,
    zRandMemberCountWithScores: ZRANDMEMBER_COUNT_WITHSCORES2,
    ZRANDMEMBER_COUNT: ZRANDMEMBER_COUNT2,
    zRandMemberCount: ZRANDMEMBER_COUNT2,
    ZRANDMEMBER: ZRANDMEMBER2,
    zRandMember: ZRANDMEMBER2,
    ZRANGE_WITHSCORES: ZRANGE_WITHSCORES2,
    zRangeWithScores: ZRANGE_WITHSCORES2,
    ZRANGE: ZRANGE2,
    zRange: ZRANGE2,
    ZRANGEBYLEX: ZRANGEBYLEX2,
    zRangeByLex: ZRANGEBYLEX2,
    ZRANGEBYSCORE_WITHSCORES: ZRANGEBYSCORE_WITHSCORES2,
    zRangeByScoreWithScores: ZRANGEBYSCORE_WITHSCORES2,
    ZRANGEBYSCORE: ZRANGEBYSCORE2,
    zRangeByScore: ZRANGEBYSCORE2,
    ZRANGESTORE: ZRANGESTORE2,
    zRangeStore: ZRANGESTORE2,
    ZRANK: ZRANK2,
    zRank: ZRANK2,
    ZREM: ZREM2,
    zRem: ZREM2,
    ZREMRANGEBYLEX: ZREMRANGEBYLEX2,
    zRemRangeByLex: ZREMRANGEBYLEX2,
    ZREMRANGEBYRANK: ZREMRANGEBYRANK2,
    zRemRangeByRank: ZREMRANGEBYRANK2,
    ZREMRANGEBYSCORE: ZREMRANGEBYSCORE2,
    zRemRangeByScore: ZREMRANGEBYSCORE2,
    ZREVRANK: ZREVRANK2,
    zRevRank: ZREVRANK2,
    ZSCAN: ZSCAN2,
    ...
    ZSCORE: ZSCORE2,
    zScore: ZSCORE2,
    ZUNION_WITHSCORES: ZUNION_WITHSCORES2,
    zUnionWithScores: ZUNION_WITHSCORES2,
    ZUNION: ZUNION2,
    zUnion: ZUNION2,
    ZUNIONSTORE: ZUNIONSTORE2,
    zUnionStore: ZUNIONSTORE2
  };
  return commands$5;
}
...
function requireCOMMAND_INFO() {
  ...
  function transformArguments(commands2) {
    return ["COMMAND", "INFO", ...commands2];
  }
...
function requireFLUSHALL() {
  ...
  var RedisFlushModes2;
  (function(RedisFlushModes3) {
    RedisFlushModes3["ASYNC"] = "ASYNC";
    RedisFlushModes3["SYNC"] = "SYNC";
  })(RedisFlushModes2 || (FLUSHALL.RedisFlushModes = RedisFlushModes2 = {}));
  function transformArguments(mode) {
    const args = ["FLUSHALL"];
    if (mode) {
      args.push(mode);
...
function requireCommands$5() {
  ...
  const ACL_CAT2 = requireACL_CAT();
  const ACL_DELUSER2 = requireACL_DELUSER();
  const ACL_DRYRUN2 = requireACL_DRYRUN();
  const ACL_GENPASS2 = requireACL_GENPASS();
  const ACL_GETUSER2 = requireACL_GETUSER();
  const ACL_LIST2 = requireACL_LIST();
  const ACL_LOAD2 = requireACL_LOAD();
  const ACL_LOG_RESET2 = requireACL_LOG_RESET();
  const ACL_LOG2 = requireACL_LOG();
  const ACL_SAVE2 = requireACL_SAVE();
  const ACL_SETUSER2 = requireACL_SETUSER();
  const ACL_USERS2 = requireACL_USERS();
  const ACL_WHOAMI2 = requireACL_WHOAMI();
  const ASKING2 = requireASKING();
  const AUTH2 = requireAUTH();
  const BGREWRITEAOF2 = requireBGREWRITEAOF();
  const BGSAVE2 = requireBGSAVE();
  const CLIENT_CACHING2 = requireCLIENT_CACHING();
  const CLIENT_GETNAME2 = requireCLIENT_GETNAME();
  const CLIENT_GETREDIR2 = requireCLIENT_GETREDIR();
  const CLIENT_ID2 = requireCLIENT_ID();
  const CLIENT_KILL2 = requireCLIENT_KILL();
  const CLIENT_LIST2 = requireCLIENT_LIST();
  const CLIENT_NO_EVICT = requireCLIENT_NOEVICT();
  const CLIENT_NO_TOUCH = requireCLIENT_NOTOUCH();
  const CLIENT_PAUSE2 = requireCLIENT_PAUSE();
  const CLIENT_SETNAME2 = requireCLIENT_SETNAME();
  const CLIENT_TRACKING2 = requireCLIENT_TRACKING();
  const CLIENT_TRACKINGINFO2 = requireCLIENT_TRACKINGINFO();
  const CLIENT_UNPAUSE2 = requireCLIENT_UNPAUSE();
  const CLIENT_INFO2 = requireCLIENT_INFO();
  const CLUSTER_ADDSLOTS2 = requireCLUSTER_ADDSLOTS();
  const CLUSTER_ADDSLOTSRANGE2 = requireCLUSTER_ADDSLOTSRANGE();
  const CLUSTER_BUMPEPOCH2 = requireCLUSTER_BUMPEPOCH();
  const CLUSTER_COUNT_FAILURE_REPORTS = requireCLUSTER_COUNTFAILUREREPORTS();
  const CLUSTER_COUNTKEYSINSLOT2 = requireCLUSTER_COUNTKEYSINSLOT();
  const CLUSTER_DELSLOTS2 = requireCLUSTER_DELSLOTS();
  const CLUSTER_DELSLOTSRANGE2 = requireCLUSTER_DELSLOTSRANGE();
  const CLUSTER_FAILOVER2 = requireCLUSTER_FAILOVER();
  const CLUSTER_FLUSHSLOTS2 = requireCLUSTER_FLUSHSLOTS();
  const CLUSTER_FORGET2 = requireCLUSTER_FORGET();
  const CLUSTER_GETKEYSINSLOT2 = requireCLUSTER_GETKEYSINSLOT();
  const CLUSTER_INFO2 = requireCLUSTER_INFO();
  const CLUSTER_KEYSLOT2 = requireCLUSTER_KEYSLOT();
  const CLUSTER_LINKS2 = requireCLUSTER_LINKS();
  const CLUSTER_MEET2 = requireCLUSTER_MEET();
  const CLUSTER_MYID2 = requireCLUSTER_MYID();
  const CLUSTER_MYSHARDID2 = requireCLUSTER_MYSHARDID();
  const CLUSTER_NODES2 = requireCLUSTER_NODES();
  const CLUSTER_REPLICAS2 = requireCLUSTER_REPLICAS();
  const CLUSTER_REPLICATE2 = requireCLUSTER_REPLICATE();
  const CLUSTER_RESET2 = requireCLUSTER_RESET();
  const CLUSTER_SAVECONFIG2 = requireCLUSTER_SAVECONFIG();
  const CLUSTER_SET_CONFIG_EPOCH = requireCLUSTER_SETCONFIGEPOCH();
  const CLUSTER_SETSLOT2 = requireCLUSTER_SETSLOT();
  const CLUSTER_SLOTS2 = requireCLUSTER_SLOTS();
  const COMMAND_COUNT2 = requireCOMMAND_COUNT();
  const COMMAND_GETKEYS2 = requireCOMMAND_GETKEYS();
  const COMMAND_GETKEYSANDFLAGS2 = requireCOMMAND_GETKEYSANDFLAGS();
  const COMMAND_INFO2 = requireCOMMAND_INFO();
  const COMMAND_LIST2 = requireCOMMAND_LIST();
  const COMMAND2 = requireCOMMAND();
  const CONFIG_GET2 = requireCONFIG_GET$2();
  const CONFIG_RESETASTAT = requireCONFIG_RESETSTAT();
  const CONFIG_REWRITE2 = requireCONFIG_REWRITE();
  const CONFIG_SET2 = requireCONFIG_SET$2();
  const DBSIZE2 = requireDBSIZE();
  const DISCARD2 = requireDISCARD();
  const ECHO2 = requireECHO();
  const FAILOVER2 = requireFAILOVER();
  const FLUSHALL2 = requireFLUSHALL();
  const FLUSHDB2 = requireFLUSHDB();
  const FUNCTION_DELETE2 = requireFUNCTION_DELETE();
  const FUNCTION_DUMP2 = requireFUNCTION_DUMP();
  const FUNCTION_FLUSH2 = requireFUNCTION_FLUSH();
  const FUNCTION_KILL2 = requireFUNCTION_KILL();
  const FUNCTION_LIST_WITHCODE2 = requireFUNCTION_LIST_WITHCODE();
  const FUNCTION_LIST2 = requireFUNCTION_LIST();
  const FUNCTION_LOAD2 = requireFUNCTION_LOAD();
  const FUNCTION_RESTORE2 = requireFUNCTION_RESTORE();
  const FUNCTION_STATS2 = requireFUNCTION_STATS();
  const HELLO2 = requireHELLO();
  const INFO2 = requireINFO$7();
  const KEYS2 = requireKEYS();
  const LASTSAVE2 = requireLASTSAVE();
  const LATENCY_DOCTOR2 = requireLATENCY_DOCTOR();
  const LATENCY_GRAPH2 = requireLATENCY_GRAPH();
  const LATENCY_HISTORY2 = requireLATENCY_HISTORY();
  const LATENCY_LATEST2 = requireLATENCY_LATEST();
  const LOLWUT2 = requireLOLWUT();
  const MEMORY_DOCTOR2 = requireMEMORY_DOCTOR();
  const MEMORY_MALLOC_STATS = requireMEMORY_MALLOCSTATS();
  const MEMORY_PURGE2 = requireMEMORY_PURGE();
  const MEMORY_STATS2 = requireMEMORY_STATS();
  const MEMORY_USAGE2 = requireMEMORY_USAGE();
  const MODULE_LIST2 = requireMODULE_LIST();
  const MODULE_LOAD2 = requireMODULE_LOAD();
  const MODULE_UNLOAD2 = requireMODULE_UNLOAD();
  const MOVE2 = requireMOVE();
  const PING2 = requirePING();
  const PUBSUB_CHANNELS2 = requirePUBSUB_CHANNELS();
  const PUBSUB_NUMPAT2 = requirePUBSUB_NUMPAT();
  const PUBSUB_NUMSUB2 = requirePUBSUB_NUMSUB();
  const PUBSUB_SHARDCHANNELS2 = requirePUBSUB_SHARDCHANNELS();
  const PUBSUB_SHARDNUMSUB2 = requirePUBSUB_SHARDNUMSUB();
  const RANDOMKEY2 = requireRANDOMKEY();
  const READONLY2 = requireREADONLY();
  const READWRITE2 = requireREADWRITE();
  const REPLICAOF2 = requireREPLICAOF();
  const RESTORE_ASKING = requireRESTOREASKING();
  const ROLE2 = requireROLE();
  const SAVE2 = requireSAVE();
  const SCAN2 = requireSCAN();
  const SCRIPT_DEBUG2 = requireSCRIPT_DEBUG();
  const SCRIPT_EXISTS2 = requireSCRIPT_EXISTS();
  const SCRIPT_FLUSH2 = requireSCRIPT_FLUSH();
  const SCRIPT_KILL2 = requireSCRIPT_KILL();
  const SCRIPT_LOAD2 = requireSCRIPT_LOAD();
  const SHUTDOWN2 = requireSHUTDOWN();
  const SWAPDB2 = requireSWAPDB();
  const TIME2 = requireTIME();
  const UNWATCH2 = requireUNWATCH();
  const WAIT2 = requireWAIT();
  commands$6.default = {
    ...commands_1.default,
    ACL_CAT: ACL_CAT2,
    aclCat: ACL_CAT2,
    ACL_DELUSER: ACL_DELUSER2,
    aclDelUser: ACL_DELUSER2,
    ACL_DRYRUN: ACL_DRYRUN2,
    aclDryRun: ACL_DRYRUN2,
    ACL_GENPASS: ACL_GENPASS2,
    aclGenPass: ACL_GENPASS2,
    ACL_GETUSER: ACL_GETUSER2,
    aclGetUser: ACL_GETUSER2,
    ACL_LIST: ACL_LIST2,
    aclList: ACL_LIST2,
    ACL_LOAD: ACL_LOAD2,
    aclLoad: ACL_LOAD2,
    ACL_LOG_RESET: ACL_LOG_RESET2,
    aclLogReset: ACL_LOG_RESET2,
    ACL_LOG: ACL_LOG2,
    aclLog: ACL_LOG2,
    ACL_SAVE: ACL_SAVE2,
    aclSave: ACL_SAVE2,
    ACL_SETUSER: ACL_SETUSER2,
    aclSetUser: ACL_SETUSER2,
    ACL_USERS: ACL_USERS2,
    aclUsers: ACL_USERS2,
    ACL_WHOAMI: ACL_WHOAMI2,
    aclWhoAmI: ACL_WHOAMI2,
    ASKING: ASKING2,
    asking: ASKING2,
    AUTH: AUTH2,
    auth: AUTH2,
    BGREWRITEAOF: BGREWRITEAOF2,
    bgRewriteAof: BGREWRITEAOF2,
    BGSAVE: BGSAVE2,
    bgSave: BGSAVE2,
    CLIENT_CACHING: CLIENT_CACHING2,
    clientCaching: CLIENT_CACHING2,
    CLIENT_GETNAME: CLIENT_GETNAME2,
    clientGetName: CLIENT_GETNAME2,
    CLIENT_GETREDIR: CLIENT_GETREDIR2,
    clientGetRedir: CLIENT_GETREDIR2,
    CLIENT_ID: CLIENT_ID2,
    clientId: CLIENT_ID2,
    CLIENT_KILL: CLIENT_KILL2,
    clientKill: CLIENT_KILL2,
    "CLIENT_NO-EVICT": CLIENT_NO_EVICT,
    clientNoEvict: CLIENT_NO_EVICT,
    "CLIENT_NO-TOUCH": CLIENT_NO_TOUCH,
    clientNoTouch: CLIENT_NO_TOUCH,
    CLIENT_LIST: CLIENT_LIST2,
    clientList: CLIENT_LIST2,
    CLIENT_PAUSE: CLIENT_PAUSE2,
    clientPause: CLIENT_PAUSE2,
    CLIENT_SETNAME: CLIENT_SETNAME2,
    clientSetName: CLIENT_SETNAME2,
    CLIENT_TRACKING: CLIENT_TRACKING2,
    clientTracking: CLIENT_TRACKING2,
    CLIENT_TRACKINGINFO: CLIENT_TRACKINGINFO2,
    clientTrackingInfo: CLIENT_TRACKINGINFO2,
    CLIENT_UNPAUSE: CLIENT_UNPAUSE2,
    clientUnpause: CLIENT_UNPAUSE2,
    CLIENT_INFO: CLIENT_INFO2,
    clientInfo: CLIENT_INFO2,
    CLUSTER_ADDSLOTS: CLUSTER_ADDSLOTS2,
    clusterAddSlots: CLUSTER_ADDSLOTS2,
    CLUSTER_ADDSLOTSRANGE: CLUSTER_ADDSLOTSRANGE2,
    clusterAddSlotsRange: CLUSTER_ADDSLOTSRANGE2,
    CLUSTER_BUMPEPOCH: CLUSTER_BUMPEPOCH2,
    clusterBumpEpoch: CLUSTER_BUMPEPOCH2,
    CLUSTER_COUNT_FAILURE_REPORTS,
    clusterCountFailureReports: CLUSTER_COUNT_FAILURE_REPORTS,
    CLUSTER_COUNTKEYSINSLOT: CLUSTER_COUNTKEYSINSLOT2,
    clusterCountKeysInSlot: CLUSTER_COUNTKEYSINSLOT2,
    CLUSTER_DELSLOTS: CLUSTER_DELSLOTS2,
    clusterDelSlots: CLUSTER_DELSLOTS2,
    CLUSTER_DELSLOTSRANGE: CLUSTER_DELSLOTSRANGE2,
    clusterDelSlotsRange: CLUSTER_DELSLOTSRANGE2,
    CLUSTER_FAILOVER: CLUSTER_FAILOVER2,
    clusterFailover: CLUSTER_FAILOVER2,
    CLUSTER_FLUSHSLOTS: CLUSTER_FLUSHSLOTS2,
    clusterFlushSlots: CLUSTER_FLUSHSLOTS2,
    CLUSTER_FORGET: CLUSTER_FORGET2,
    clusterForget: CLUSTER_FORGET2,
    CLUSTER_GETKEYSINSLOT: CLUSTER_GETKEYSINSLOT2,
    clusterGetKeysInSlot: CLUSTER_GETKEYSINSLOT2,
    CLUSTER_INFO: CLUSTER_INFO2,
    clusterInfo: CLUSTER_INFO2,
    CLUSTER_KEYSLOT: CLUSTER_KEYSLOT2,
    clusterKeySlot: CLUSTER_KEYSLOT2,
    CLUSTER_LINKS: CLUSTER_LINKS2,
    clusterLinks: CLUSTER_LINKS2,
    CLUSTER_MEET: CLUSTER_MEET2,
    clusterMeet: CLUSTER_MEET2,
    CLUSTER_MYID: CLUSTER_MYID2,
    clusterMyId: CLUSTER_MYID2,
    CLUSTER_MYSHARDID: CLUSTER_MYSHARDID2,
    clusterMyShardId: CLUSTER_MYSHARDID2,
    CLUSTER_NODES: CLUSTER_NODES2,
    clusterNodes: CLUSTER_NODES2,
    CLUSTER_REPLICAS: CLUSTER_REPLICAS2,
    clusterReplicas: CLUSTER_REPLICAS2,
    CLUSTER_REPLICATE: CLUSTER_REPLICATE2,
    clusterReplicate: CLUSTER_REPLICATE2,
    CLUSTER_RESET: CLUSTER_RESET2,
    clusterReset: CLUSTER_RESET2,
    CLUSTER_SAVECONFIG: CLUSTER_SAVECONFIG2,
    clusterSaveConfig: CLUSTER_SAVECONFIG2,
    CLUSTER_SET_CONFIG_EPOCH,
    clusterSetConfigEpoch: CLUSTER_SET_CONFIG_EPOCH,
    CLUSTER_SETSLOT: CLUSTER_SETSLOT2,
    clusterSetSlot: CLUSTER_SETSLOT2,
    CLUSTER_SLOTS: CLUSTER_SLOTS2,
    clusterSlots: CLUSTER_SLOTS2,
    COMMAND_COUNT: COMMAND_COUNT2,
    commandCount: COMMAND_COUNT2,
    COMMAND_GETKEYS: COMMAND_GETKEYS2,
    commandGetKeys: COMMAND_GETKEYS2,
    COMMAND_GETKEYSANDFLAGS: COMMAND_GETKEYSANDFLAGS2,
    commandGetKeysAndFlags: COMMAND_GETKEYSANDFLAGS2,
    COMMAND_INFO: COMMAND_INFO2,
    commandInfo: COMMAND_INFO2,
    COMMAND_LIST: COMMAND_LIST2,
    commandList: COMMAND_LIST2,
    COMMAND: COMMAND2,
    command: COMMAND2,
    CONFIG_GET: CONFIG_GET2,
    configGet: CONFIG_GET2,
    CONFIG_RESETASTAT,
    configResetStat: CONFIG_RESETASTAT,
    CONFIG_REWRITE: CONFIG_REWRITE2,
    configRewrite: CONFIG_REWRITE2,
    CONFIG_SET: CONFIG_SET2,
    ...
    FLUSHDB: FLUSHDB2,
    flushDb: FLUSHDB2,
    FUNCTION_DELETE: FUNCTION_DELETE2,
    functionDelete: FUNCTION_DELETE2,
    FUNCTION_DUMP: FUNCTION_DUMP2,
    functionDump: FUNCTION_DUMP2,
    FUNCTION_FLUSH: FUNCTION_FLUSH2,
    functionFlush: FUNCTION_FLUSH2,
    FUNCTION_KILL: FUNCTION_KILL2,
    functionKill: FUNCTION_KILL2,
    FUNCTION_LIST_WITHCODE: FUNCTION_LIST_WITHCODE2,
    functionListWithCode: FUNCTION_LIST_WITHCODE2,
    FUNCTION_LIST: FUNCTION_LIST2,
    functionList: FUNCTION_LIST2,
    FUNCTION_LOAD: FUNCTION_LOAD2,
    functionLoad: FUNCTION_LOAD2,
    FUNCTION_RESTORE: FUNCTION_RESTORE2,
    functionRestore: FUNCTION_RESTORE2,
    FUNCTION_STATS: FUNCTION_STATS2,
    functionStats: FUNCTION_STATS2,
    HELLO: HELLO2,
    hello: HELLO2,
    INFO: INFO2,
    info: INFO2,
    ...
    LASTSAVE: LASTSAVE2,
    lastSave: LASTSAVE2,
    LATENCY_DOCTOR: LATENCY_DOCTOR2,
    latencyDoctor: LATENCY_DOCTOR2,
    LATENCY_GRAPH: LATENCY_GRAPH2,
    latencyGraph: LATENCY_GRAPH2,
    LATENCY_HISTORY: LATENCY_HISTORY2,
    latencyHistory: LATENCY_HISTORY2,
    LATENCY_LATEST: LATENCY_LATEST2,
    latencyLatest: LATENCY_LATEST2,
    LOLWUT: LOLWUT2,
    lolwut: LOLWUT2,
    MEMORY_DOCTOR: MEMORY_DOCTOR2,
    memoryDoctor: MEMORY_DOCTOR2,
    "MEMORY_MALLOC-STATS": MEMORY_MALLOC_STATS,
    memoryMallocStats: MEMORY_MALLOC_STATS,
    MEMORY_PURGE: MEMORY_PURGE2,
    memoryPurge: MEMORY_PURGE2,
    MEMORY_STATS: MEMORY_STATS2,
    memoryStats: MEMORY_STATS2,
    MEMORY_USAGE: MEMORY_USAGE2,
    memoryUsage: MEMORY_USAGE2,
    MODULE_LIST: MODULE_LIST2,
    moduleList: MODULE_LIST2,
    MODULE_LOAD: MODULE_LOAD2,
    moduleLoad: MODULE_LOAD2,
    MODULE_UNLOAD: MODULE_UNLOAD2,
    moduleUnload: MODULE_UNLOAD2,
    MOVE: MOVE2,
    move: MOVE2,
    PING: PING2,
    ping: PING2,
    PUBSUB_CHANNELS: PUBSUB_CHANNELS2,
    pubSubChannels: PUBSUB_CHANNELS2,
    PUBSUB_NUMPAT: PUBSUB_NUMPAT2,
    pubSubNumPat: PUBSUB_NUMPAT2,
    PUBSUB_NUMSUB: PUBSUB_NUMSUB2,
    pubSubNumSub: PUBSUB_NUMSUB2,
    PUBSUB_SHARDCHANNELS: PUBSUB_SHARDCHANNELS2,
    pubSubShardChannels: PUBSUB_SHARDCHANNELS2,
    PUBSUB_SHARDNUMSUB: PUBSUB_SHARDNUMSUB2,
    pubSubShardNumSub: PUBSUB_SHARDNUMSUB2,
    ...
    SCAN: SCAN2,
    scan: SCAN2,
    SCRIPT_DEBUG: SCRIPT_DEBUG2,
    scriptDebug: SCRIPT_DEBUG2,
    SCRIPT_EXISTS: SCRIPT_EXISTS2,
    scriptExists: SCRIPT_EXISTS2,
    SCRIPT_FLUSH: SCRIPT_FLUSH2,
    scriptFlush: SCRIPT_FLUSH2,
    SCRIPT_KILL: SCRIPT_KILL2,
    scriptKill: SCRIPT_KILL2,
    SCRIPT_LOAD: SCRIPT_LOAD2,
    scriptLoad: SCRIPT_LOAD2,
    SHUTDOWN: SHUTDOWN2,
    shutdown: SHUTDOWN2,
    SWAPDB: SWAPDB2,
    swapDb: SWAPDB2,
...
function requireErrors$1() {
  ...
  errors$1.AbortError = AbortError2;
  class WatchError2 extends Error {
    constructor() {
      super("One (or more) of the watched keys has been changed");
    }
  }
  errors$1.WatchError = WatchError2;
  class ConnectionTimeoutError2 extends Error {
    constructor() {
      super("Connection timeout");
    }
  }
  errors$1.ConnectionTimeoutError = ConnectionTimeoutError2;
  class ClientClosedError2 extends Error {
    constructor() {
      super("The client is closed");
    }
  }
  errors$1.ClientClosedError = ClientClosedError2;
  class ClientOfflineError2 extends Error {
    constructor() {
      super("The client is offline");
    }
  }
  errors$1.ClientOfflineError = ClientOfflineError2;
  class DisconnectsClientError2 extends Error {
    constructor() {
      super("Disconnects client");
    }
  }
  errors$1.DisconnectsClientError = DisconnectsClientError2;
  class SocketClosedUnexpectedlyError2 extends Error {
    constructor() {
      super("Socket closed unexpectedly");
    }
  }
  errors$1.SocketClosedUnexpectedlyError = SocketClosedUnexpectedlyError2;
  class RootNodesUnavailableError2 extends Error {
    constructor() {
      super("All the root nodes are unavailable");
    }
  }
  errors$1.RootNodesUnavailableError = RootNodesUnavailableError2;
  class ReconnectStrategyError2 extends Error {
  ...
  errors$1.ReconnectStrategyError = ReconnectStrategyError2;
  class ErrorReply2 extends Error {
    constructor(message) {
      super(message);
      this.stack = void 0;
    }
  }
  errors$1.ErrorReply = ErrorReply2;
  class MultiErrorReply2 extends ErrorReply2 {
    ...
    *errors() {
      for (const index2 of this.errorIndexes) {
        yield this.replies[index2];
      }
    }
  }
  errors$1.MultiErrorReply = MultiErrorReply2;
  return errors$1;
}
var utils$1 = {};
...
function requireSocket() {
  ...
  _a = RedisSocket, _RedisSocket_initiator = /* @__PURE__ */ new WeakMap(), _RedisSocket_options = /* @__PURE__ */ new WeakMap(), _RedisSocket_socket = /* @__PURE__ */ new WeakMap(), _RedisSocket_isOpen = /* @__PURE__ */ new WeakMap(), _RedisSocket_isReady = /* @__PURE__ */ new WeakMap(), _RedisSocket_writableNeedDrain = /* @__PURE__ */ new WeakMap(), _RedisSocket_isSocketUnrefed = /* @__PURE__ */ new WeakMap(), _RedisSocket_isCorked = /* @__PURE__ */ new WeakMap(), _RedisSocket_instances = /* @__PURE__ */ new WeakSet(), _RedisSocket_initiateOptions = function _RedisSocket_initiateOptions2(options) {
    ...
    return new Promise((resolve, reject) => {
      const { connectEvent, socket: socket2 } = __classPrivateFieldGet(_a, _a, "m", _RedisSocket_isTlsSocket).call(_a, __classPrivateFieldGet(this, _RedisSocket_options, "f")) ? __classPrivateFieldGet(this, _RedisSocket_instances, "m", _RedisSocket_createTlsSocket).call(this) : __classPrivateFieldGet(this, _RedisSocket_instances, "m", _RedisSocket_createNetSocket).call(this);
      if (__classPrivateFieldGet(this, _RedisSocket_options, "f").connectTimeout) {
        socket2.setTimeout(__classPrivateFieldGet(this, _RedisSocket_options, "f").connectTimeout, () => socket2.destroy(new errors_1.ConnectionTimeoutError()));
      }
      if (__classPrivateFieldGet(this, _RedisSocket_isSocketUnrefed, "f")) {
        socket2.unref();
      }
      socket2.setNoDelay(__classPrivateFieldGet(this, _RedisSocket_options, "f").noDelay).once("error", reject).once(connectEvent, () => {
        socket2.setTimeout(0).setKeepAlive(__classPrivateFieldGet(this, _RedisSocket_options, "f").keepAlive !== false, __classPrivateFieldGet(this, _RedisSocket_options, "f").keepAlive || 0).off("error", reject).once("error", (err) => __classPrivateFieldGet(this, _RedisSocket_instances, "m", _RedisSocket_onSocketError).call(this, err)).once("close", (hadError) => {
          if (!hadError && __classPrivateFieldGet(this, _RedisSocket_isOpen, "f") && __classPrivateFieldGet(this, _RedisSocket_socket, "f") === socket2) {
...
function requireString() {
  ...
  class StringComposer {
    ...
    write(buffer2) {
      ...
      const string2 = this.string + this.decoder.end(buffer2);
      this.string = "";
      return string2;
    }
    reset() {
...
function requireCommandsQueue() {
  ...
  class RedisCommandsQueue {
    ...
    resubscribe() {
      const commands2 = __classPrivateFieldGet(this, _RedisCommandsQueue_pubSub, "f").resubscribe();
      if (!commands2.length)
        return;
      return Promise.all(commands2.map((command) => __classPrivateFieldGet(this, _RedisCommandsQueue_instances, "m", _RedisCommandsQueue_pushPubSubCommand).call(this, command)));
    }
...
function requireCommander() {
  ...
  function attachCommands({ BaseClass, commands: commands2, executor }) {
  ...
  function attachWithNamespaces({ BaseClass, namespaces, executor }) {
    ...
    for (const [namespace, commands2] of Object.entries(namespaces)) {
...
function requireClient() {
  ...
  class RedisClient extends events_1.EventEmitter {
    ...
    async multiExecutor(commands2, selectedDB, chainId) {
      ...
      const promise = chainId ? (
        ...
        Promise.all([
          ...
          __classPrivateFieldGet(this, _RedisClient_instances, "m", _RedisClient_addMultiCommands).call(this, commands2, chainId),
          __classPrivateFieldGet(this, _RedisClient_queue, "f").addCommand(["EXEC"], { chainId })
        ])
      ) : __classPrivateFieldGet(this, _RedisClient_instances, "m", _RedisClient_addMultiCommands).call(this, commands2);
      __classPrivateFieldGet(this, _RedisClient_instances, "m", _RedisClient_tick).call(this);
  ...
  }, _RedisClient_addMultiCommands = function _RedisClient_addMultiCommands2(commands2, chainId) {
    return Promise.all(commands2.map(({ args }) => __classPrivateFieldGet(this, _RedisClient_queue, "f").addCommand(args, { chainId })));
...
function requireClusterSlots() {
  ...
  _a = RedisClusterSlots, _RedisClusterSlots_options = /* @__PURE__ */ new WeakMap(), _RedisClusterSlots_Client = /* @__PURE__ */ new WeakMap(), _RedisClusterSlots_emit = /* @__PURE__ */ new WeakMap(), _RedisClusterSlots_isOpen = /* @__PURE__ */ new WeakMap(), _RedisClusterSlots_runningRediscoverPromise = /* @__PURE__ */ new WeakMap(), _RedisClusterSlots_randomNodeIterator = /* @__PURE__ */ new WeakMap(), _RedisClusterSlots_instances = /* @__PURE__ */ new WeakSet(), _RedisClusterSlots_discoverWithRootNodes = async function _RedisClusterSlots_discoverWithRootNodes2() {
    ...
    const index2 = Math.floor(Math.random() * (this.masters.length + this.replicas.length)), node = index2 < this.masters.length ? this.masters[index2] : this.replicas[index2 - this.masters.length];
    this.pubSubNode = {
...
function requireCluster() {
  ...
  class RedisCluster extends events_1.EventEmitter {
    ...
    MULTI(routing) {
      return new (__classPrivateFieldGet(this, _RedisCluster_Multi, "f"))((commands2, firstKey, chainId) => {
        return __classPrivateFieldGet(this, _RedisCluster_instances, "m", _RedisCluster_execute).call(this, firstKey, false, (client2) => client2.multiExecutor(commands2, void 0, chainId));
      }, routing);
    }
...
function requireLuaScript() {
  ...
  luaScript.defineScript = defineScript2;
...
function requireSCANDUMP$1() {
  ...
  function transformArguments(key, iterator2) {
    return ["BF.SCANDUMP", key, iterator2.toString()];
  }
  SCANDUMP$1.transformArguments = transformArguments;
  function transformReply([iterator2, chunk]) {
    return {
      iterator: iterator2,
      chunk
    };
...
function requireBloom() {
  ...
  const ADD2 = requireADD$4();
  const CARD2 = requireCARD();
  const EXISTS2 = requireEXISTS$1();
  const INFO2 = requireINFO$6();
  const INSERT2 = requireINSERT$1();
  const LOADCHUNK2 = requireLOADCHUNK$1();
  const MADD2 = requireMADD$1();
  const MEXISTS2 = requireMEXISTS();
  const RESERVE2 = requireRESERVE$2();
  const SCANDUMP2 = requireSCANDUMP$1();
  bloom.default = {
    ADD: ADD2,
    add: ADD2,
    CARD: CARD2,
...
function requireCountMinSketch() {
  ...
  const INCRBY2 = requireINCRBY$2();
  const INFO2 = requireINFO$5();
  const INITBYDIM2 = requireINITBYDIM();
  const INITBYPROB2 = requireINITBYPROB();
  const MERGE2 = requireMERGE$2();
  const QUERY2 = requireQUERY$2();
  countMinSketch.default = {
    INCRBY: INCRBY2,
    incrBy: INCRBY2,
    INFO: INFO2,
    info: INFO2,
    INITBYDIM: INITBYDIM2,
    initByDim: INITBYDIM2,
    INITBYPROB: INITBYPROB2,
    initByProb: INITBYPROB2,
    MERGE: MERGE2,
    merge: MERGE2,
    QUERY: QUERY2,
...
function requireLOADCHUNK() {
  ...
  function transformArguments(key, iterator2, chunk) {
    return ["CF.LOADCHUNK", key, iterator2.toString(), chunk];
  }
...
function requireSCANDUMP() {
  ...
  function transformArguments(key, iterator2) {
    return ["CF.SCANDUMP", key, iterator2.toString()];
  }
...
function requireCuckoo() {
  ...
  const ADD2 = requireADD$3();
  const ADDNX2 = requireADDNX();
  const COUNT2 = requireCOUNT$1();
  const DEL2 = requireDEL$2();
  const EXISTS2 = requireEXISTS();
  const INFO2 = requireINFO$4();
  const INSERT2 = requireINSERT();
  const INSERTNX2 = requireINSERTNX();
  const LOADCHUNK2 = requireLOADCHUNK();
  const RESERVE2 = requireRESERVE$1();
  const SCANDUMP2 = requireSCANDUMP();
  const generic_transformers_1 = requireGenericTransformers();
  cuckoo.default = {
    ADD: ADD2,
    add: ADD2,
...
function requireTDigest() {
  ...
  const ADD2 = requireADD$2();
  const BYRANK2 = requireBYRANK();
  const BYREVRANK2 = requireBYREVRANK();
  const CDF2 = requireCDF();
  const CREATE2 = requireCREATE$2();
  const INFO2 = requireINFO$3();
  const MAX2 = requireMAX();
  const MERGE2 = requireMERGE$1();
  const MIN2 = requireMIN();
  const QUANTILE2 = requireQUANTILE();
  const RANK2 = requireRANK();
  const RESET2 = requireRESET();
  const REVRANK2 = requireREVRANK();
  const TRIMMED_MEAN2 = requireTRIMMED_MEAN();
  tDigest.default = {
    ADD: ADD2,
    add: ADD2,
    BYRANK: BYRANK2,
    byRank: BYRANK2,
    BYREVRANK: BYREVRANK2,
    byRevRank: BYREVRANK2,
    CDF: CDF2,
    cdf: CDF2,
    CREATE: CREATE2,
...
function requireRESERVE() {
  ...
  function transformArguments(key, topK2, options) {
    const args = ["TOPK.RESERVE", key, topK2.toString()];
    if (options) {
...
function requireTopK() {
  ...
  const INCRBY2 = requireINCRBY$1();
  const INFO2 = requireINFO$2();
  const LIST_WITHCOUNT2 = requireLIST_WITHCOUNT();
  const LIST2 = requireLIST$1();
  const QUERY2 = requireQUERY$1();
  const RESERVE2 = requireRESERVE();
  topK.default = {
    ADD: ADD2,
    add: ADD2,
    COUNT: COUNT2,
    ...
    INFO: INFO2,
    info: INFO2,
    LIST_WITHCOUNT: LIST_WITHCOUNT2,
    listWithCount: LIST_WITHCOUNT2,
    LIST: LIST2,
    list: LIST2,
    QUERY: QUERY2,
    query: QUERY2,
...
function requireQUERY() {
  ...
  function transformArguments(graph2, query, options, compact) {
    return (0, _1.pushQueryArguments)(["GRAPH.QUERY"], graph2, query, options, compact);
  }
...
function requireRO_QUERY() {
  ...
  (function(exports) {
    ...
    exports.IS_READ_ONLY = true;
    function transformArguments(graph2, query, options, compact) {
      return (0, _1.pushQueryArguments)(["GRAPH.RO_QUERY"], graph2, query, options, compact);
    }
    exports.transformArguments = transformArguments;
...
function requireCommands$3() {
  ...
  const CONFIG_GET2 = requireCONFIG_GET$1();
  const CONFIG_SET2 = requireCONFIG_SET$1();
  const DELETE2 = requireDELETE();
  const EXPLAIN2 = requireEXPLAIN$1();
  const LIST2 = requireLIST();
  const PROFILE2 = requirePROFILE();
  const QUERY2 = requireQUERY();
  const RO_QUERY2 = requireRO_QUERY();
  const SLOWLOG2 = requireSLOWLOG();
  commands$3.default = {
    CONFIG_GET: CONFIG_GET2,
    configGet: CONFIG_GET2,
    CONFIG_SET: CONFIG_SET2,
  ...
  function pushQueryArguments(args, graph2, query, options, compact) {
    args.push(graph2);
...
function requireARRINSERT() {
  ...
  function transformArguments(key, path, index2, ...jsons) {
    const args = ["JSON.ARRINSERT", key, path, index2.toString()];
    for (const json of jsons) {
      args.push((0, _1.transformRedisJsonArgument)(json));
    }
    return args;
...
function requireARRPOP() {
  ...
  function transformArguments(key, path, index2) {
...
function requireCommands$2() {
  ...
  const ARRAPPEND2 = requireARRAPPEND();
  const ARRINDEX2 = requireARRINDEX();
  const ARRINSERT2 = requireARRINSERT();
  const ARRLEN2 = requireARRLEN();
  const ARRPOP2 = requireARRPOP();
  const ARRTRIM2 = requireARRTRIM();
  const DEBUG_MEMORY2 = requireDEBUG_MEMORY();
  const DEL2 = requireDEL$1();
  const FORGET2 = requireFORGET();
  const GET2 = requireGET$1();
  const MERGE2 = requireMERGE();
  const MGET2 = requireMGET$1();
  const MSET2 = requireMSET();
  const NUMINCRBY2 = requireNUMINCRBY();
  const NUMMULTBY2 = requireNUMMULTBY();
  const OBJKEYS2 = requireOBJKEYS();
  const OBJLEN2 = requireOBJLEN();
  const RESP2 = requireRESP();
  const SET2 = requireSET();
  const STRAPPEND2 = requireSTRAPPEND();
  const STRLEN2 = requireSTRLEN();
  const TYPE2 = requireTYPE();
  commands$2.default = {
    ARRAPPEND: ARRAPPEND2,
    arrAppend: ARRAPPEND2,
    ARRINDEX: ARRINDEX2,
    arrIndex: ARRINDEX2,
    ARRINSERT: ARRINSERT2,
    arrInsert: ARRINSERT2,
    ARRLEN: ARRLEN2,
    arrLen: ARRLEN2,
    ARRPOP: ARRPOP2,
    ...
    ARRTRIM: ARRTRIM2,
    arrTrim: ARRTRIM2,
    DEBUG_MEMORY: DEBUG_MEMORY2,
    debugMemory: DEBUG_MEMORY2,
    DEL: DEL2,
    del: DEL2,
    FORGET: FORGET2,
    forget: FORGET2,
    ...
    MSET: MSET2,
    mSet: MSET2,
    NUMINCRBY: NUMINCRBY2,
    numIncrBy: NUMINCRBY2,
    NUMMULTBY: NUMMULTBY2,
    numMultBy: NUMMULTBY2,
    OBJKEYS: OBJKEYS2,
    objKeys: OBJKEYS2,
    OBJLEN: OBJLEN2,
...
function requireAGGREGATE() {
  ...
  const _1 = requireCommands$1();
  var AggregateSteps2;
  (function(AggregateSteps3) {
    AggregateSteps3["GROUPBY"] = "GROUPBY";
    AggregateSteps3["SORTBY"] = "SORTBY";
    AggregateSteps3["APPLY"] = "APPLY";
    AggregateSteps3["LIMIT"] = "LIMIT";
    AggregateSteps3["FILTER"] = "FILTER";
  })(AggregateSteps2 || (AGGREGATE.AggregateSteps = AggregateSteps2 = {}));
  var AggregateGroupByReducers2;
  (function(AggregateGroupByReducers3) {
    AggregateGroupByReducers3["COUNT"] = "COUNT";
    AggregateGroupByReducers3["COUNT_DISTINCT"] = "COUNT_DISTINCT";
    AggregateGroupByReducers3["COUNT_DISTINCTISH"] = "COUNT_DISTINCTISH";
    AggregateGroupByReducers3["SUM"] = "SUM";
    AggregateGroupByReducers3["MIN"] = "MIN";
    AggregateGroupByReducers3["MAX"] = "MAX";
    AggregateGroupByReducers3["AVG"] = "AVG";
    AggregateGroupByReducers3["STDDEV"] = "STDDEV";
    AggregateGroupByReducers3["QUANTILE"] = "QUANTILE";
    AggregateGroupByReducers3["TOLIST"] = "TOLIST";
    AggregateGroupByReducers3["TO_LIST"] = "TOLIST";
    AggregateGroupByReducers3["FIRST_VALUE"] = "FIRST_VALUE";
    AggregateGroupByReducers3["RANDOM_SAMPLE"] = "RANDOM_SAMPLE";
  })(AggregateGroupByReducers2 || (AGGREGATE.AggregateGroupByReducers = AggregateGroupByReducers2 = {}));
  AGGREGATE.FIRST_KEY_INDEX = 1;
  AGGREGATE.IS_READ_ONLY = true;
  function transformArguments(index2, query, options) {
    return pushAggregatehOptions(["FT.AGGREGATE", index2, query], options);
  }
      ...
      for (const step of options.STEPS) {
        switch (step.type) {
          case AggregateSteps2.GROUPBY:
            ...
            break;
          case AggregateSteps2.SORTBY:
            (0, _1.pushSortByArguments)(args, "SORTBY", step.BY);
            if (step.MAX) {
              args.push("MAX", step.MAX.toString());
            }
            break;
          case AggregateSteps2.APPLY:
            args.push("APPLY", step.expression, "AS", step.AS);
            break;
          case AggregateSteps2.LIMIT:
            args.push("LIMIT", step.from.toString(), step.size.toString());
            break;
          case AggregateSteps2.FILTER:
  ...
  function pushGroupByReducer(args, reducer) {
    ...
    switch (reducer.type) {
      case AggregateGroupByReducers2.COUNT:
        args.push("0");
        break;
      case AggregateGroupByReducers2.COUNT_DISTINCT:
      case AggregateGroupByReducers2.COUNT_DISTINCTISH:
      case AggregateGroupByReducers2.SUM:
      case AggregateGroupByReducers2.MIN:
      case AggregateGroupByReducers2.MAX:
      case AggregateGroupByReducers2.AVG:
      case AggregateGroupByReducers2.STDDEV:
      case AggregateGroupByReducers2.TOLIST:
        args.push("1", reducer.property);
        break;
      case AggregateGroupByReducers2.QUANTILE:
        args.push("2", reducer.property, reducer.quantile.toString());
        break;
      case AggregateGroupByReducers2.FIRST_VALUE: {
        (0, _1.pushArgumentsWithLength)(args, () => {
      ...
      case AggregateGroupByReducers2.RANDOM_SAMPLE:
...
function requireAGGREGATE_WITHCURSOR() {
  ...
  (function(exports) {
    ...
    function transformArguments(index2, query, options) {
      const args = (0, AGGREGATE_1.transformArguments)(index2, query, options);
...
function requireCURSOR_DEL() {
  ...
  function transformArguments(index2, cursorId) {
    return [
      "FT.CURSOR",
      "DEL",
      index2,
...
function requireCURSOR_READ() {
  ...
  (function(exports) {
    ...
    exports.FIRST_KEY_INDEX = 1;
    exports.IS_READ_ONLY = true;
    function transformArguments(index2, cursor, options) {
      const args = [
        "FT.CURSOR",
        "READ",
        index2,
...
function requireEXPLAIN() {
  ...
  function transformArguments(index2, query, options) {
    const args = ["FT.EXPLAIN", index2, query];
    (0, _1.pushParamsArgs)(args, options?.PARAMS);
    if (options?.DIALECT) {
      args.push("DIALECT", options.DIALECT.toString());
    }
...
function requireSEARCH() {
  ...
  function transformArguments(index2, query, options) {
    return (0, _1.pushSearchOptions)(["FT.SEARCH", index2, query], options);
  }
...
function requirePROFILE_SEARCH() {
  ...
  function transformArguments(index2, query, options) {
    let args = ["FT.PROFILE", index2, "SEARCH"];
    if (options?.LIMITED) {
      args.push("LIMITED");
    }
...
function requireSEARCH_NOCONTENT() {
  ...
  function transformArguments(index2, query, options) {
    return (0, _1.pushSearchOptions)(["FT.SEARCH", index2, query, "NOCONTENT"], options);
  }
...
function requireSUGADD() {
  ...
  function transformArguments(key, string2, score, options) {
    const args = ["FT.SUGADD", key, string2, score.toString()];
    if (options?.INCR) {
      args.push("INCR");
    }
    if (options?.PAYLOAD) {
...
function requireSUGDEL() {
  ...
  (function(exports) {
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.transformReply = exports.transformArguments = void 0;
    function transformArguments(key, string2) {
      return ["FT.SUGDEL", key, string2];
    }
    exports.transformArguments = transformArguments;
    var generic_transformers_1 = requireGenericTransformers();
    Object.defineProperty(exports, "transformReply", { enumerable: true, get: function() {
...
function requireCommands$1() {
  ...
  const _LIST2 = require_LIST();
  const ALTER2 = requireALTER$1();
  const AGGREGATE_WITHCURSOR2 = requireAGGREGATE_WITHCURSOR();
  const AGGREGATE2 = requireAGGREGATE();
  const ALIASADD2 = requireALIASADD();
  const ALIASDEL2 = requireALIASDEL();
  const ALIASUPDATE2 = requireALIASUPDATE();
  const CONFIG_GET2 = requireCONFIG_GET();
  const CONFIG_SET2 = requireCONFIG_SET();
  const CREATE2 = requireCREATE$1();
  const CURSOR_DEL2 = requireCURSOR_DEL();
  const CURSOR_READ2 = requireCURSOR_READ();
  const DICTADD2 = requireDICTADD();
  const DICTDEL2 = requireDICTDEL();
  const DICTDUMP2 = requireDICTDUMP();
  const DROPINDEX2 = requireDROPINDEX();
  const EXPLAIN2 = requireEXPLAIN();
  const EXPLAINCLI2 = requireEXPLAINCLI();
  const INFO2 = requireINFO$1();
  const PROFILESEARCH = requirePROFILE_SEARCH();
  const PROFILEAGGREGATE = requirePROFILE_AGGREGATE();
  const SEARCH2 = requireSEARCH();
  const SEARCH_NOCONTENT2 = requireSEARCH_NOCONTENT();
  const SPELLCHECK2 = requireSPELLCHECK();
  const SUGADD2 = requireSUGADD();
  const SUGDEL2 = requireSUGDEL();
  const SUGGET_WITHPAYLOADS2 = requireSUGGET_WITHPAYLOADS();
  const SUGGET_WITHSCORES_WITHPAYLOADS2 = requireSUGGET_WITHSCORES_WITHPAYLOADS();
  const SUGGET_WITHSCORES2 = requireSUGGET_WITHSCORES();
  const SUGGET2 = requireSUGGET();
  const SUGLEN2 = requireSUGLEN();
  const SYNDUMP2 = requireSYNDUMP();
  const SYNUPDATE2 = requireSYNUPDATE();
  const TAGVALS2 = requireTAGVALS();
  const generic_transformers_1 = requireGenericTransformers();
  commands$1.default = {
    _LIST: _LIST2,
    _list: _LIST2,
    ALTER: ALTER2,
    alter: ALTER2,
    AGGREGATE_WITHCURSOR: AGGREGATE_WITHCURSOR2,
    aggregateWithCursor: AGGREGATE_WITHCURSOR2,
    ...
    CREATE: CREATE2,
    create: CREATE2,
    CURSOR_DEL: CURSOR_DEL2,
    cursorDel: CURSOR_DEL2,
    CURSOR_READ: CURSOR_READ2,
    cursorRead: CURSOR_READ2,
    DICTADD: DICTADD2,
    dictAdd: DICTADD2,
    DICTDEL: DICTDEL2,
    dictDel: DICTDEL2,
    ...
    SEARCH: SEARCH2,
    search: SEARCH2,
    SEARCH_NOCONTENT: SEARCH_NOCONTENT2,
    searchNoContent: SEARCH_NOCONTENT2,
    ...
    SUGDEL: SUGDEL2,
    sugDel: SUGDEL2,
    SUGGET_WITHPAYLOADS: SUGGET_WITHPAYLOADS2,
    sugGetWithPayloads: SUGGET_WITHPAYLOADS2,
    SUGGET_WITHSCORES_WITHPAYLOADS: SUGGET_WITHSCORES_WITHPAYLOADS2,
    sugGetWithScoresWithPayloads: SUGGET_WITHSCORES_WITHPAYLOADS2,
    SUGGET_WITHSCORES: SUGGET_WITHSCORES2,
    sugGetWithScores: SUGGET_WITHSCORES2,
    SUGGET: SUGGET2,
    sugGet: SUGGET2,
    SUGLEN: SUGLEN2,
    sugLen: SUGLEN2,
    SYNDUMP: SYNDUMP2,
    synDump: SYNDUMP2,
    SYNUPDATE: SYNUPDATE2,
    synUpdate: SYNUPDATE2,
    TAGVALS: TAGVALS2,
    tagVals: TAGVALS2
  };
  var RedisSearchLanguages2;
  (function(RedisSearchLanguages3) {
    RedisSearchLanguages3["ARABIC"] = "Arabic";
    RedisSearchLanguages3["BASQUE"] = "Basque";
    RedisSearchLanguages3["CATALANA"] = "Catalan";
    RedisSearchLanguages3["DANISH"] = "Danish";
    RedisSearchLanguages3["DUTCH"] = "Dutch";
    RedisSearchLanguages3["ENGLISH"] = "English";
    RedisSearchLanguages3["FINNISH"] = "Finnish";
    RedisSearchLanguages3["FRENCH"] = "French";
    RedisSearchLanguages3["GERMAN"] = "German";
    RedisSearchLanguages3["GREEK"] = "Greek";
    RedisSearchLanguages3["HUNGARIAN"] = "Hungarian";
    RedisSearchLanguages3["INDONESAIN"] = "Indonesian";
    RedisSearchLanguages3["IRISH"] = "Irish";
    RedisSearchLanguages3["ITALIAN"] = "Italian";
    RedisSearchLanguages3["LITHUANIAN"] = "Lithuanian";
    RedisSearchLanguages3["NEPALI"] = "Nepali";
    RedisSearchLanguages3["NORWEIGAN"] = "Norwegian";
    RedisSearchLanguages3["PORTUGUESE"] = "Portuguese";
    RedisSearchLanguages3["ROMANIAN"] = "Romanian";
    RedisSearchLanguages3["RUSSIAN"] = "Russian";
    RedisSearchLanguages3["SPANISH"] = "Spanish";
    RedisSearchLanguages3["SWEDISH"] = "Swedish";
    RedisSearchLanguages3["TAMIL"] = "Tamil";
    RedisSearchLanguages3["TURKISH"] = "Turkish";
    RedisSearchLanguages3["CHINESE"] = "Chinese";
  })(RedisSearchLanguages2 || (commands$1.RedisSearchLanguages = RedisSearchLanguages2 = {}));
  ...
  (function(SchemaFieldTypes3) {
    ...
    SchemaFieldTypes3["VECTOR"] = "VECTOR";
    SchemaFieldTypes3["GEOSHAPE"] = "GEOSHAPE";
  })(SchemaFieldTypes2 || (commands$1.SchemaFieldTypes = SchemaFieldTypes2 = {}));
  ...
  var SchemaTextFieldPhonetics2;
  (function(SchemaTextFieldPhonetics3) {
    SchemaTextFieldPhonetics3["DM_EN"] = "dm:en";
    SchemaTextFieldPhonetics3["DM_FR"] = "dm:fr";
    SchemaTextFieldPhonetics3["FM_PT"] = "dm:pt";
    SchemaTextFieldPhonetics3["DM_ES"] = "dm:es";
  })(SchemaTextFieldPhonetics2 || (commands$1.SchemaTextFieldPhonetics = SchemaTextFieldPhonetics2 = {}));
  var VectorAlgorithms2;
  (function(VectorAlgorithms3) {
    VectorAlgorithms3["FLAT"] = "FLAT";
    VectorAlgorithms3["HNSW"] = "HNSW";
  })(VectorAlgorithms2 || (commands$1.VectorAlgorithms = VectorAlgorithms2 = {}));
    ...
    for (const [field, fieldOptions] of Object.entries(schema)) {
      ...
      switch (fieldOptions.type) {
        case SchemaFieldTypes2.TEXT:
          ...
          break;
        case SchemaFieldTypes2.NUMERIC:
        case SchemaFieldTypes2.GEO:
          pushCommonFieldArguments(args, fieldOptions);
          break;
        case SchemaFieldTypes2.TAG:
        ...
        case SchemaFieldTypes2.VECTOR:
          ...
          pushArgumentsWithLength(args, () => {
            ...
            switch (fieldOptions.ALGORITHM) {
              case VectorAlgorithms2.FLAT:
                if (fieldOptions.BLOCK_SIZE) {
                  args.push("BLOCK_SIZE", fieldOptions.BLOCK_SIZE.toString());
                }
                break;
              case VectorAlgorithms2.HNSW:
                if (fieldOptions.M) {
          ...
          break;
        case SchemaFieldTypes2.GEOSHAPE:
...
function requireCommands() {
  ...
  const ALTER2 = requireALTER();
  const CREATE2 = requireCREATE();
  const CREATERULE2 = requireCREATERULE();
  const DECRBY2 = requireDECRBY();
  const DEL2 = requireDEL();
  const DELETERULE2 = requireDELETERULE();
  const GET2 = requireGET();
  const INCRBY2 = requireINCRBY();
  const INFO_DEBUG2 = requireINFO_DEBUG();
  const INFO2 = requireINFO();
  const MADD2 = requireMADD();
  const MGET2 = requireMGET();
  const MGET_WITHLABELS2 = requireMGET_WITHLABELS();
  const QUERYINDEX2 = requireQUERYINDEX();
  const RANGE2 = requireRANGE();
  const REVRANGE2 = requireREVRANGE();
  const MRANGE2 = requireMRANGE();
  const MRANGE_WITHLABELS2 = requireMRANGE_WITHLABELS();
  const MREVRANGE2 = requireMREVRANGE();
  const MREVRANGE_WITHLABELS2 = requireMREVRANGE_WITHLABELS();
  const generic_transformers_1 = requireGenericTransformers();
  commands.default = {
    ADD: ADD2,
    add: ADD2,
    ...
    INCRBY: INCRBY2,
    incrBy: INCRBY2,
    INFO_DEBUG: INFO_DEBUG2,
    infoDebug: INFO_DEBUG2,
    INFO: INFO2,
    info: INFO2,
    MADD: MADD2,
    mAdd: MADD2,
    MGET: MGET2,
    mGet: MGET2,
    MGET_WITHLABELS: MGET_WITHLABELS2,
    mGetWithLabels: MGET_WITHLABELS2,
    ...
    MRANGE: MRANGE2,
    mRange: MRANGE2,
    MRANGE_WITHLABELS: MRANGE_WITHLABELS2,
    mRangeWithLabels: MRANGE_WITHLABELS2,
    MREVRANGE: MREVRANGE2,
    mRevRange: MREVRANGE2,
    MREVRANGE_WITHLABELS: MREVRANGE_WITHLABELS2,
    mRevRangeWithLabels: MREVRANGE_WITHLABELS2
  };
  var TimeSeriesAggregationType2;
  (function(TimeSeriesAggregationType3) {
    TimeSeriesAggregationType3["AVG"] = "AVG";
    TimeSeriesAggregationType3["AVERAGE"] = "AVG";
    TimeSeriesAggregationType3["FIRST"] = "FIRST";
    TimeSeriesAggregationType3["LAST"] = "LAST";
    TimeSeriesAggregationType3["MIN"] = "MIN";
    TimeSeriesAggregationType3["MINIMUM"] = "MIN";
    TimeSeriesAggregationType3["MAX"] = "MAX";
    TimeSeriesAggregationType3["MAXIMUM"] = "MAX";
    TimeSeriesAggregationType3["SUM"] = "SUM";
    TimeSeriesAggregationType3["RANGE"] = "RANGE";
    TimeSeriesAggregationType3["COUNT"] = "COUNT";
    TimeSeriesAggregationType3["STD_P"] = "STD.P";
    TimeSeriesAggregationType3["STD_S"] = "STD.S";
    TimeSeriesAggregationType3["VAR_P"] = "VAR.P";
    TimeSeriesAggregationType3["VAR_S"] = "VAR.S";
    TimeSeriesAggregationType3["TWA"] = "TWA";
  })(TimeSeriesAggregationType2 || (commands.TimeSeriesAggregationType = TimeSeriesAggregationType2 = {}));
  var TimeSeriesDuplicatePolicies2;
  (function(TimeSeriesDuplicatePolicies3) {
    TimeSeriesDuplicatePolicies3["BLOCK"] = "BLOCK";
    TimeSeriesDuplicatePolicies3["FIRST"] = "FIRST";
    TimeSeriesDuplicatePolicies3["LAST"] = "LAST";
    TimeSeriesDuplicatePolicies3["MIN"] = "MIN";
    TimeSeriesDuplicatePolicies3["MAX"] = "MAX";
    TimeSeriesDuplicatePolicies3["SUM"] = "SUM";
  })(TimeSeriesDuplicatePolicies2 || (commands.TimeSeriesDuplicatePolicies = TimeSeriesDuplicatePolicies2 = {}));
  var TimeSeriesReducers2;
  (function(TimeSeriesReducers3) {
    TimeSeriesReducers3["AVG"] = "AVG";
    TimeSeriesReducers3["SUM"] = "SUM";
    TimeSeriesReducers3["MIN"] = "MIN";
    TimeSeriesReducers3["MINIMUM"] = "MIN";
    TimeSeriesReducers3["MAX"] = "MAX";
    TimeSeriesReducers3["MAXIMUM"] = "MAX";
    TimeSeriesReducers3["RANGE"] = "range";
    TimeSeriesReducers3["COUNT"] = "COUNT";
    TimeSeriesReducers3["STD_P"] = "STD.P";
    TimeSeriesReducers3["STD_S"] = "STD.S";
    TimeSeriesReducers3["VAR_P"] = "VAR.P";
    TimeSeriesReducers3["VAR_S"] = "VAR.S";
  })(TimeSeriesReducers2 || (commands.TimeSeriesReducers = TimeSeriesReducers2 = {}));
  ...
  var TimeSeriesEncoding2;
  (function(TimeSeriesEncoding3) {
    TimeSeriesEncoding3["COMPRESSED"] = "COMPRESSED";
    TimeSeriesEncoding3["UNCOMPRESSED"] = "UNCOMPRESSED";
  })(TimeSeriesEncoding2 || (commands.TimeSeriesEncoding = TimeSeriesEncoding2 = {}));
  ...
  var TimeSeriesBucketTimestamp2;
  (function(TimeSeriesBucketTimestamp3) {
    TimeSeriesBucketTimestamp3["LOW"] = "-";
    TimeSeriesBucketTimestamp3["HIGH"] = "+";
    TimeSeriesBucketTimestamp3["MID"] = "~";
  })(TimeSeriesBucketTimestamp2 || (commands.TimeSeriesBucketTimestamp = TimeSeriesBucketTimestamp2 = {}));
...
function requireDist() {
  ...
  (function(exports) {
    ...
    function createCluster2(options) {
    ...
    exports.createCluster = createCluster2;
  })(dist$6);
  return dist$6;
}
var distExports$1 = requireDist();
const index = /* @__PURE__ */ getDefaultExportFromCjs(distExports$1);
const redis = /* @__PURE__ */ _mergeNamespaces({
  __proto__: null,
  default: index
}, [distExports$1]);
...
const createClient = distExports.createClient;
const createCluster = distExports.createCluster;
export {
  AbortError,
  AggregateGroupByReducers,
  AggregateSteps,
